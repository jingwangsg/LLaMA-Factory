...
torchrun --nnodes $NNODES \
    ...
    --dataset_dir $HOME/DATASET/mmo1/ \
    --dataset "mmr1_geminipro_core30k,mmr1_geminipro_bonus60k,tiku_geminipro_bonus30k,mmo1_v0_text_alpaca" \
    --template qwen2_vl \
    --cutoff_len 16384 \
    --overwrite_cache \
    --preprocessing_num_workers 32 \
    --output_dir saves/mmo1-math-qwen2.5_vl_7b-sft_mmr1_core90k_tiku30k \
    --logging_steps 10 \
    --save_strategy epoch \
    --plot_loss \
    ...
    --report_to wandb \
    --run_name mmo1-math-qwen2.5_vl_7b-sft_mmr1_core90k_tiku30k