...
GRAD_ACCUM_STEP=$((128 / NPROC_PER_NODE / NNODES))
...
torchrun --nnodes $NNODES \
    ...
    --deepspeed examples/deepspeed/ds_z3_mics_8shards.json \
    --dataset_dir $HOME/DATASET/mmo1/ \
    --dataset "mmr1_all_sft_pub85k_tiku25k" \
    --template qwen2_vl \
    --cutoff_len 16384 \
    --overwrite_cache \
    --preprocessing_num_workers 32 \
    --output_dir saves/mmo1-math-qwen2.5_vl_7b-sft_mmr1_pub85k_tiku25k \
    --logging_steps 10 \
    --save_strategy epoch \
    --plot_loss \
    ...
    --report_to wandb \
    --run_name mmo1-math-qwen2.5_vl_7b-sft_mmr1_pub85k_tiku25k